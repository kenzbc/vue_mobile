  ...
  <div>
      ...
      <div class="goods-content">
        <section v-if="is_success == true" class="">
          ...
          <div class="warn">
            ...
            <p>请认准唯一客服QQ：2031363458，809043669</p>
    ...
    <div class="goods-detail" v-else>
      <div class="goods-content" style="font-size:24px;">
        ...
        4.联系客服QQ：<span style="color:#5e5c9a">2031363458，809043669</span><br><br>
    ...
    <div class="conversion" v-if="param.status != 2">
      ...
      <button v-else class="button disable">{{detailList.button}}</button>
    </div>
...
<style lang="stylus" scoped>
  *{ max-height: 999999px;}
  ...
  .button.disable{
    ...
    box-shadow:0px 12px 8px -8px rgba(178,176,210,0.5);
    border-radius:12px;
    font-size:28px;
